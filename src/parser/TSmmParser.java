...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		RULE_funcDefinition = 4, RULE_parameters = 5, RULE_functionInvocation = 6, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"parameters", "functionInvocation", "statementFunctionInvocation", "arguments", 
			"statement", "block", "expression", "simple_type", "type", "mainDefinition"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					((ProgramContext)_localctx).definition = definition();
					 _localctx.p.addDefinitions(((ProgramContext)_localctx).definition.ast); 
					}
					} 
				}
				setState(37);
			...
			_localctx.p.addDefinition(((ProgramContext)_localctx).mainDefinition.ast);
			setState(40);
			match(EOF);
			 ((ProgramContext)_localctx).ast =  _localctx.p; 
			}
		}
	...
	public final VarDefinitionContext varDefinition() throws RecognitionException {
		...
		try {
			...
			match(T__2);
			        ...
			        _localctx.ast.add(new VarDefinition(((VarDefinitionContext)_localctx).ID.getLine(),((VarDefinitionContext)_localctx).ID.getCharPositionInLine()+1,((VarDefinitionContext)_localctx).t.ast, (((VarDefinitionContext)_localctx).ID!=null?((VarDefinitionContext)_localctx).ID.getText():null)));
	...
	public final FunctionInvocationContext functionInvocation() throws RecognitionException {
		...
		try {
			...
			match(T__6);
			            ...
			            ((FunctionInvocationContext)_localctx).ast =  new FunctionInvocation(
			                ((FunctionInvocationContext)_localctx).ID.getLine(),
			                ((FunctionInvocationContext)_localctx).ID.getCharPositionInLine()+1,
			                new Variable(
			                    ((FunctionInvocationContext)_localctx).ID.getLine(),
			                    ((FunctionInvocationContext)_localctx).ID.getCharPositionInLine()+1,
			                    (((FunctionInvocationContext)_localctx).ID!=null?((FunctionInvocationContext)_localctx).ID.getText():null)),
			                ((FunctionInvocationContext)_localctx).arguments.ast);
		...
		try {
			...
			case 1:
				...
				match(T__2);
				            ...
				            for(Expression e : ((StatementContext)_localctx).arguments.ast){ _localctx.ast.add( new LogStatement(
				                        e.getLine(),
				                        e.getColumn(),
				                        e));
				            }
	...
	public final MainDefinitionContext mainDefinition() throws RecognitionException {
		...
		try {
			...
			match(T__4);
			setState(316);
			((MainDefinitionContext)_localctx).id = match(T__38);
			setState(317);
			match(T__5);
			setState(318);
			match(T__6);
