...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, T__41=42, T__42=43, WHITES=44, COMMENT=45, 
		INT_CONSTANT=46, CHAR_CONSTANT=47, REAL_CONSTANT=48, ID=49;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, "WHITES", "COMMENT", 
			"INT_CONSTANT", "CHAR_CONSTANT", "REAL_CONSTANT", "ID"
		};
	}
	...
	public final FuncDefinitionContext funcDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1055531366881344L) != 0)) {
				{
				{
				setState(92);
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1055531363991616L) != 0)) {
				{
				setState(130);
		...
		try {
			...
			case 4:
				...
				match(T__2);
				                     ...
				                     _localctx.ast.add(new ArithmeticAssignment(
				                             ((StatementContext)_localctx).e1.ast.getLine(),
				                             ((StatementContext)_localctx).e1.ast.getColumn(),
				                             ((StatementContext)_localctx).e1.ast,
				                             ((StatementContext)_localctx).e2.ast,
	...
	public final MainDefinitionContext mainDefinition() throws RecognitionException {
		...
		try {
			...
			match(T__4);
			setState(316);
			((MainDefinitionContext)_localctx).id = match(T__42);
			setState(317);
			match(T__5);
			setState(318);
			match(T__6);
