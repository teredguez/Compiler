...
public class TSmmParser extends Parser {
	...
	public final VarDefinitionContext varDefinition() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				match(T__3);
				setState(61);
				((VarDefinitionContext)_localctx).expression = expression(0);
				setState(62);
				match(T__2);

				    _localctx.ast.add( new LetStatement(((VarDefinitionContext)_localctx).ID.getLine(),((VarDefinitionContext)_localctx).ID.getCharPositionInLine()+1,
				                                null, (((VarDefinitionContext)_localctx).ID!=null?((VarDefinitionContext)_localctx).ID.getText():null),
				                                new Variable(((VarDefinitionContext)_localctx).ID.getLine(), ((VarDefinitionContext)_localctx).ID.getCharPositionInLine()+1, (((VarDefinitionContext)_localctx).ID!=null?((VarDefinitionContext)_localctx).ID.getText():null)),
				                                ((VarDefinitionContext)_localctx).expression.ast));
	...
	public final FuncDefinitionContext funcDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 65970710442112L) != 0)) {
				{
				{
				setState(101);
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 65970710249600L) != 0)) {
				{
				setState(139);
