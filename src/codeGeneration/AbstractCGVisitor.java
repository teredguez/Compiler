...
public class AbstractCGVisitor<TR,TP> implements Visitor<TR, TP>  {
    ...
    @Override
    public TR visit(AssignmentExpression a, TP param) {
        throw new UnsupportedOperationException(getClass().getSimpleName() + " does not support visiting AssignmentExpression");
    }
}
